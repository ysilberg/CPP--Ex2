...
bool test3Profile()
{
  ...
  try
  {
    ...
    cout << "Adding 2 devices to each user: ... \n"
         << endl;
    ...
    cout << "Creating a profile for each user with empty status and posts: ... \n"
         << endl;
    ...
    if (got != expected)
    {
      ...
      std::cout << "FAILED: Page information is not as expected\n"
                << "check functions Profile::getPage(), Profile::getStatus(), " << "Profile::setStatus(), Profile::addPostToProfilePage() \n";
      return false;
      set_console_color(WHITE);
    }

    cout << "Clears User objects: ... \n"
         << endl;
...
bool test3Bonus()
{
  ...
  cout << "Initializing user1: ... \n"
       << endl;

  User user1;
  user1.init(123456789, "Gal", 17);

  cout << "Creating a profile for the user with random status and posts: ... \n"
       << endl;
  ...
  cout << "Changing all words in the status to \"Magshimim\": ... \n"
       << endl;
  ...
  cout << "Changing the word \"" << word_to_replace << "\" in the status to \"" << replacement << "\": ... \n"
       << endl;
